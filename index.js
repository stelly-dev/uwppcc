...
const subsetCardCss = ":host{display:block;--font-family:'wfont_efc4ce_afb53a4134974c9ea0c66bce8fcc3d34,wf_afb53a4134974c9ea0c66bce8,orig_cubano_regular'}.card{display:flex;align-items:center;justify-content:space-between;width:100%;height:80px;background-color:#fff;border-radius:5px;box-shadow:0px 0px 10px rgba(0, 0, 0, 0.1);margin-bottom:4px;padding:1rem;box-sizing:border-box}.subset_title{font-size:1rem;color:#ed5829;font-family:var(--font-family), sans-serif;font-weight:400}.subset_button{background:white;border:none;width:50px;display:flex;justify-content:center;align-items:center;cursor:pointer}.subset_icon{height:50px}.subset_icon svg{width:30px;height:30px}.pin{margin-right:-6px}.subset_icon .trash{margin-right:-4px}.subset_icon p{margin:0;font-size:0.8rem;font-weight:600}";
