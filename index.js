...
const emailModalCss = ":host{display:grid}.mouse-trap{position:fixed;top:0;left:0;width:100%;height:100%;z-index:1000;background:rgba(0, 0, 0, 0.5);cursor:pointer}.email-modal{position:fixed;top:50%;left:50%;transform:translate(-50%, -50%);width:900px;height:500px;border-radius:15px;padding:1rem;z-index:1001;display:flex;flex-direction:column;justify-content:center;align-items:center;display:grid;background:#232323;grid-template-columns:1fr 1fr;grid-template-rows:repeat(12, 1fr);grid-gap:1rem}.guide{grid-area:1 / 2 / span 12 / span 2;height:100%;width:calc(100% + .25rem);color:rgba(200, 200, 200, 0.75);overflow-y:scroll;font-family:Frutiger, \"Frutiger Linotype\", Univers, Calibri, \"Gill Sans\", \"Gill Sans MT\", \"Myriad Pro\", Myriad, \"DejaVu Sans Condensed\", \"Liberation Sans\", \"Nimbus Sans L\", Tahoma, Geneva, \"Helvetica Neue\", Helvetica, Arial, sans-serif}.guide h1{font-size:1.5rem;background:-webkit-linear-gradient(orangered, #ec1271);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin-top:0;margin-bottom:.6rem;font-family:Cubano;font-weight:400}.guide h1:after{content:\":\"}.guide hr{border:0;border-top:1px solid rgba(200, 200, 200, 0.25);margin:.6rem 0}.guide ul li{margin-bottom:1rem}a{color:orangered}.scrollbar::-webkit-scrollbar{width:.5rem}.scrollbar::-webkit-scrollbar-track{background-color:#343434}.scrollbar::-webkit-scrollbar-thumb{border-radius:2px;background-color:#232323;border:1px solid #343434}.email-form{display:grid;grid-template-columns:repeat(12, 1fr);grid-template-rows:repeat(12, 1fr);grid-gap:1rem;width:100%;height:100%;position:relative;grid-area:1 / 1 / span 12 / span 1}.close-button{position:absolute;top:0;right:0;width:2rem;height:2rem;border-radius:50%;display:flex;justify-content:center;align-items:center;cursor:pointer;fill:white;background:#232323;border:none}.close-button:focus{fill:orangered}.return-address{grid-column:1 / 13;grid-row:1 / 1;display:flex;flex-direction:column}.sender-name{grid-column:1 / 13;grid-row:2 / 2;display:flex;flex-direction:column}label{font-size:0.8rem;font-family:'Cubano';color:orangered}input,textarea{background:#565656;border:none;color:white;padding:.5rem;font-size:16px;margin-top:.75rem;border-radius:3px}input:focus{outline:2px solid orangered}textarea:focus{outline:1px solid orangered}.email-body{display:flex;flex-direction:column;grid-column:1 / 13;grid-row:3 / 11;max-width:100%;max-height:100%;resize:none}.email-body>textarea{height:100%;resize:none;font-family:'Roboto', sans-serif;padding:.5rem}button:not(.close-button){border-radius:3rem;max-height:50%;margin-top:calc(25% / 2);cursor:pointer;outline:none;font-family:'Cubano';transition:all cubic-bezier(0.165, 0.84, 0.44, 1) 0.3s}.send-button{grid-column:10 / 13;grid-row:11 / 13;border:none}.clear-button{grid-column:07 / 10;grid-row:11/ 13;background-color:transparent;color:orangered;border:2px solid white;box-sizing:border-box}.clear-button:hover{background-color:orangered;color:white}.clear-button:focus{outline:3px solid orangered}.send-button:focus{outline:3px solid orangered}.send-button:active,.clear-button:active{transform:scale(0.95);background-color:white;color:black}.send-button:hover{background:orangered;color:white}";
...
const EmailModal$1 = class extends H {
  ...
  render() {
    return (this.open ? h(Host, null, h("aside", { class: "email-modal" }, h("button", { class: "close-button", onClick: this.mouseTrapClickHandler }, h("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", width: "24", height: "24" }, h("path", { fill: "none", d: "M0 0h24v24H0z" }), h("path", { d: "M13.414 12l5.293 5.293-1.414 1.414-5.293-5.293-5.293 5.293-1.414-1.414L10.586 12 5.293 6.707l1.414-1.414L12 10.586l5.293-5.293 1.414 1.414L13.414 12z" }))), h("div", { class: "email-form", onKeyDown: (e) => this.handleSpecialKeys(e) }, h("label", { htmlFor: "returnAddress", class: "return-address" }, "Your Email Address", h("input", { id: "emailInput", type: "email", onChange: (e) => this.handleInputChange(e), name: "returnAddress", value: this.returnAddress, placeholder: "Enter your email address", required: true })), h("label", { htmlFor: "name", class: "sender-name" }, "Your Name", h("input", { type: "text", onChange: (e) => this.handleInputChange(e), name: "name", value: this.name, placeholder: "Enter your name", required: true })), h("label", { htmlFor: "message", class: "email-body" }, "Message For Badge Holders", h("textarea", { class: "scrollbar", onChange: (e) => this.handleInputChange(e), name: "message", value: this.message, placeholder: 'write you message here', required: true })), h("button", { class: "clear-button", onClick: () => this.clearMessageHandler() }, "Clear"), h("button", { class: "send-button", onClick: () => this.sendEmailHandler() }, "send")), h("div", { class: "guide scrollbar" }, h("h1", null, "Helpful tips"), h("hr", null), h("ul", null, h("li", null, "Be sure to include your email address so that badge holders can respond to you."), h("li", null, "Be sure to include your name so that badge holders know who you are."), h("li", null, "Be sure to include a message so that badge holders know why you are contacting them.")), h("p", null, h("strong", null, "NOTE:"), " This is a free service provided by the ", h("a", { href: "https://www.lds.org", target: "_blank" }, "Church of Jesus Christ of Latter-day Saints"), ". We do not sell or share your information with anyone."), h("p", null, "Lorem ipsum, dolor sit amet consectetur adipisicing elit. Explicabo pariatur voluptas nobis ipsam? Sequi temporibus voluptate facilis natus repellat voluptates suscipit esse, ipsum odio quidem aspernatur quaerat! Voluptatem, excepturi quis. Maxime pariatur in tempora quisquam totam natus, nostrum voluptas rerum voluptatum minus optio ratione eligendi odit dolore neque illum modi sint magni! Accusantium dolorem ratione accusamus eligendi amet, unde cumque! Cum quibusdam beatae ipsa dignissimos reiciendis non magni consectetur commodi modi facere vel reprehenderit aspernatur quisquam, illum excepturi natus ea laudantium eos adipisci eveniet, ab sequi. Ab repellendus accusantium sapiente. Asperiores blanditiis, et quam delectus modi voluptatibus dolores ut numquam reiciendis sit, vel laudantium? Commodi, totam excepturi. Quaerat sit corporis placeat. Sed, obcaecati explicabo. Exercitationem illum temporibus dign
um, magni repellendus autem doloremque minus, laboriosam nemo temporibus dolorum voluptatem illum pariatur nisi suscipit consectetur. Sed error aperiam commodi fugiat autem temporibus id repudiandae nostrum ipsum tenetur. In iure voluptas sequi! Modi, sit! Illo ea, molestiae eos accusantium a corporis, dolorem inventore iste quidem eaque dicta, vel aliquid optio deserunt cumque voluptates quisquam voluptatibus at aut sunt."))), h("div", { class: "mouse-trap", onClick: (e) => this.mouseTrapClickHandler(e) })) : null);
  }
  get el() { return this; }
...
const searchResultRepeaterItemCss = ":host{display:block}@font-face{font-family:'Cubano';src:url('../../cubano-webfont.woff2') format('woff2'),\n         url('../../cubano-webfont.woff') format('woff');font-weight:normal;font-style:normal}*{box-sizing:border-box}a{all:unset}.sr-repeater-list-item{display:flex;width:100%;height:52px;margin:3px 0;background:white;border-radius:5px}.sr-repeater-item{display:flex;cursor:pointer;list-style:none}.sr-repeater-item-img{padding:3px}.sr-repeater-item div{display:flex;flex-direction:column;justify-content:space-around;padding:10px 4px}.sr-class-title,.sr-class-detail{padding:0;margin:0}.sr-class-title{font-family:'Cubano';font-size:14px}.sr-class-detail{font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;font-size:13px}.icon{width:40px;height:30px;position:absolute;top:50%;left:50%;transform:translate(-50%, -50%);z-index:1}.cap-container{position:relative;height:100%;width:40px}.cap-count{position:absolute;color:white;top:18%;left:50%;transform:translate(-50%, -50%);z-index:2;font-weight:800;font-size:12px}.rhs{margin-left:auto;height:100%;display:flex;justify-content:space-between;align-items:center;width:90px}.add_course_button{width:32px;height:32px;position:relative;border-radius:50%;outline:none;background:none;margin:.5rem;display:flex;justify-content:center;align-items:center;cursor:pointer;border:1px solid #232323a2;transition:all 400ms ease-in-out}.add_course_button:hover{border:1px solid #232323;box-shadow:1px 1px 3px 1px #23232345}.plus_sign{width:100%;height:100%;position:relative}.plus_sign div{width:1px;height:15px;background-color:black;position:absolute;top:50%;left:50%;transform-origin:center}.plus_sign div:first-of-type{transform:translate(-50%, -50%) rotate(90deg)}.plus_sign div:last-of-type{transform:translate(-50%, -50%)}";
...
const SearchResultRepeaterItem$1 = class extends H {
  ...
  renderBadgeCard() {
    ...
    return (h("li", { class: "sr-repeater-list-item" }, h("a", { class: "sr-repeater-item", href: this.badgeData.badge_link, target: "_blank", rel: "noreferrer noopener" }, h("img", { src: this.badgeData.badge_icon_uri, class: "sr-repeater-item-img" }), h("div", null, h("h2", { class: "sr-class-title", style: { color: styles.titleColor } }, details[0], ":"), h("h4", { class: "sr-class-detail" }, details[1]))), h("div", { class: "rhs" }, this.renderCapIcon(this.badgeData.number_held), this.renderAddButton())));
  }
  render() {
...
const EmailModal = /*@__PURE__*/proxyCustomElement(EmailModal$1, [1,"email-modal",{"open":[4],"returnAddress":[32],"message":[32],"name":[32]},[[7,"onkeydown","handleKeyDown"]]]);
